...
export const ScheduleDetailsModal = ({ open, schedule, onClose }: Props) => {
  const {
    lessons,
    loading,
    isSaving,
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            {isEditing ? (
              ...
              <p className="text-base text-text-secondary">
                Група №{schedule?.groupName} з {schedule?.startDate} по {schedule?.endDate}
              </p>
            )}
          </div>
