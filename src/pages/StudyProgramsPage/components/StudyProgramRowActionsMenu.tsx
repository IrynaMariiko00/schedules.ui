...
export const StudyProgramRowActionsMenu = ({
  program,
  actions,
  ...
  const handleItemClick = (tone: StudyProgramRowMenuItem['tone'], onClick: () => void) => {
    if (tone === 'danger') {
  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        title="Видалення навчальної програми"
